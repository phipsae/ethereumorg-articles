...
- What's next: Glamsterdam (realistically late 2026) brings Block-level Access Lists (EIP-7928) and ePBS. Hegotá follows, activation 2027 per Forkcast, with FOCIL (EIP-7805) Scheduled for Inclusion as its headliner. Hegotá's native-AA candidate is EIP-8141 Frame Transactions, still Draft and only Considered for Inclusion (ACDE #233, 2026-03-26). Its dependent EIP-7906 Transaction Assertions is one rung lower, Proposed for Inclusion since 2026-07-30
